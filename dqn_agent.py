...
class DQNAgent:
    ...
    def train(self):
        ...
        for step in train_progress:
            ...
            # plotting
            # if step % 200 ==0:
            #     self._plot(self.episode,n_score = 100, n_portfolio=14268)
    ...
    def test(self):
        ...
        while not done:
            ...
            # plotting
            if i % 200 ==0:
                self._plot(episode,n_score = 100, n_portfolio=14268)
